...
public class AdminReportActivity extends AppCompatActivity {
    ...
    private void initListener() {
        mActivityAdminReportBinding.tvDateFrom.setOnClickListener(view -> GlobalFunction.showDatePicker(AdminReportActivity.this,
                mActivityAdminReportBinding.tvDateFrom.getText().toString(), date -> {
                    mActivityAdminReportBinding.tvDateFrom.setText(date);
                    getListRevenue();
                }));
        mActivityAdminReportBinding.tvDateTo.setOnClickListener(view -> GlobalFunction.showDatePicker(AdminReportActivity.this,
